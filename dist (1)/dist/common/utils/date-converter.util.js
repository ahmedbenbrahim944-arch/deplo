...
class DateConverter {
    ...
    static generateYearCode(year) {
        ...
        if (yearIndex < 11) {
            return String.fromCharCode(65 + yearIndex);
        }
        else {
    ...
    static ensureYearSupported(year) {
    ...
    static convertDateToYearCode(date) {
    ...
    static convertDateToProductCodes(date) {
    ...
    static parseFromFullProductNumber(fullProductNumber) {
...
DateConverter.REVERSE_YEAR_MAPPING = {
    'A': 2020,
    'B': 2021,
    'C': 2022,
    'D': 2023,
...
DateConverter.AVAILABLE_LETTERS = 'LMNOPQRSTUVWXYZ0123456789';
//# sourceMappingURL=date-converter.util.js.map