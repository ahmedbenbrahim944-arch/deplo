...
let AdminService = class AdminService {
    ...
    async createAdmin(createAdminDto) {
        ...
        if (existingAdmin) {
            throw new common_1.ConflictException('Un admin avec ce nom existe déjà');
        }
        try {
            const saltRounds = 10;
            ...
            throw new common_1.InternalServerErrorException('Erreur lors de la création de l\'admin');
        }
    }
    async findAll() {
    ...
    async findOneByNomPrenom(nom, prenom) {
